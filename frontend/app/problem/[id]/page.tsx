...
export default async function ProblemPage({ params }: ProblemPageProps) {
  ...
  return (
    <main className="coach-workbench grid min-h-[calc(100dvh-88px)] grid-cols-1 overflow-visible md:h-[calc(100vh-56px)] md:min-h-0 md:grid-cols-[minmax(280px,24vw)_minmax(0,1fr)_minmax(320px,30vw)] md:overflow-hidden">
